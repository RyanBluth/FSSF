...
class STI {
	...
	/** NOT FOR USE OUTSIDE OF ST_GAME: Stores the timeStamp between frames */
	...
	/** Corrector for timestep and variance in deltaTime. Roughly defined as "intended number of frames since last actual frame".
	 * = deltaTime / (1000 / FPS)*/
